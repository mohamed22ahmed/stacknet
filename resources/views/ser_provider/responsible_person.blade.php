                    ...
                    <form action="" class="form-group">
                        <table class="table table-striped border-0">
                            <thead>
                              <tr>
                                <td>name</td>
                                <td><input type="text" name="name" id="name" value="Ahmed" class="form-control"></td>
                              </tr>
                            </thead>
                            <tbody>
                              <tr>
                                <td>email</td>
                                <td><input type="email" name="email" id="email" value="ahmed@gmail.com" class="form-control"></td>
                              </tr>
                              <tr>
                                <td>phone</td>
                                <td><input type="tel" name="tel" id="tel" value="01126257042" class="form-control"></td>
                              </tr>
                            </tbody>
                        </table>
