    ...
    <div class="row">
        <div class="col-xl-10 col-lg-9 col-md-8 ml-auto">
            <div class="card">
                    ...
                    <div class="task-border">
                        <table class="table border-0 ">
                            ...
                            <tbody>
                              ...
                              <tr>
                                <td>Status</td>
                                <td>Morgan Hospital Replied To You <span class="badge badge-success ml-3">Success</span> </td>
                              </tr>
                ...
                <div class="hospital-data mt-4 pl-2 ">
                    <div class="mb-4">
                        <i class="fas fa-user mr-3"></i> Replied Message Info From <span>Morgan Hospital</span>
                    </div>
                    <div class="task-border">
                        <table class="table border-0 ">
                            <thead>
