        ...
        <div class="col-xl-10 col-lg-9 col-md-8 ml-auto">
            <div class="card">
                <div class="responsible-person-data mt-4 pl-2">
                    ...
                    <form action="/comp/responsible_person" class="form-group" method="POST">
                        @csrf
                        <table class="table table-striped border-0">
                            <thead>
                              <tr>
                                <td>name</td>
                                <td><input type="text" name="name" id="name" value="{{ $res->name ??'' }}" class="form-control"></td>
                              </tr>
                            </thead>
                            <tbody>
                              <tr>
                                <td>email</td>
                                <td><input type="email" name="email" id="email" value="{{ $res->email ??'' }}" class="form-control"></td>
                              </tr>
                              <tr>
                                <td>phone</td>
                                <td><input type="text" name="phone" id="tel" value="{{ $res->phone ??'' }}" class="form-control"></td>
                              </tr>
                            </tbody>
                        </table>
